...
#   QKD_PEER_SAE_ID optional peer SAE_ID (used if no CLI arg given AND we
#                  prefer the peer over self for the smoke test)
#
...
# Priority: explicit arg > QKD_PEER_SAE_ID env > self
